...
> 面向 Linux 服务端、微服务、基础设施、游戏服务器、实时通信、存储与高性能计算场景。  
> 本文所称“常用技术栈”不是要求在一个项目中全部使用，而是给出当前 C++ 后端工程中经常出现的技术层次、代表性工具、适用边界与学习优先级。

---

## 目录

1. [C++ 后端技术栈全景](#1-c-后端技术栈全景)
2. [C++ 后端主要应用场景](#2-c-后端主要应用场景)
3. [语言与现代 C++ 基础](#3-语言与现代-c-基础)
4. [Linux 与系统编程](#4-linux-与系统编程)
5. [编译器、构建系统与依赖管理](#5-编译器构建系统与依赖管理)
6. [网络编程与 I/O 模型](#6-网络编程与-io-模型)
7. [网络库、HTTP 框架与 RPC 框架](#7-网络库http-框架与-rpc-框架)
8. [协议、序列化与接口定义](#8-协议序列化与接口定义)
9. [并发编程与异步编程](#9-并发编程与异步编程)
10. [数据库与数据访问](#10-数据库与数据访问)
11. [缓存系统](#11-缓存系统)
12. [消息队列与事件驱动](#12-消息队列与事件驱动)
13. [服务治理与分布式系统](#13-服务治理与分布式系统)
14. [网关、代理与负载均衡](#14-网关代理与负载均衡)
15. [日志、指标与链路追踪](#15-日志指标与链路追踪)
16. [测试、静态分析与代码质量](#16-测试静态分析与代码质量)
17. [调试、性能分析与故障定位](#17-调试性能分析与故障定位)
18. [安全技术栈](#18-安全技术栈)
19. [容器、部署与云原生](#19-容器部署与云原生)
20. [CI/CD 与工程协作](#20-cicd-与工程协作)
21. [常见后端架构形态](#21-常见后端架构形态)
22. [典型技术栈组合](#22-典型技术栈组合)
23. [技术选型原则](#23-技术选型原则)
24. [学习路线](#24-学习路线)
25. [面试与实际工作能力映射](#25-面试与实际工作能力映射)
26. [参考资料](#26-参考资料)
